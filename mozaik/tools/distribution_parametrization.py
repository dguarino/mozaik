...
class PyNNDistribution(RandomDistribution):
      ...
      def __init__(self,name,**params):
            ...
            RandomDistribution.__init__(self,name,params['params']) # DG: more general, values passed as params=(...) instead of named ('high':..., 'low':...)
...
class MozaikExtendedParameterSet(ParameterSet):
    ...
    def read_from_str(s,update_namespace=None):
        ...
        D=None
        try:
            # print "read_from_str", s, global_dict
